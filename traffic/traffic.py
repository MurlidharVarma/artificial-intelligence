...
def load_data(data_dir):
    ...
    # for each category
    for category_folder in range(0, NUM_CATEGORIES):
        category_dir = os.path.join(data_dir,str(category_folder))

        # loop through all images in the specific category directory
        for image_file_name in os.listdir(category_dir):
